...
internal static class DbContextSoftDeleteExtensions
{
    ...
    internal static void EnableBypassSoftDelete(this DbContext context)
    {
        GetOrCreate(context)[BypassKey] = true;
    }

    internal static void DisableBypassSoftDelete(this DbContext context)
    {
        GetOrCreate(context)[BypassKey] = false;
    }

    internal static bool IsBypassSoftDeleteEnabled(this DbContext context)
    {
